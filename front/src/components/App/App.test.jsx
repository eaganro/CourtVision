  ...
  it('wires grouped minutes-map view models into child component props', () => {
    ...
    mocks.useMinutesMapMock.mockReturnValue({
      ...
      playVm: {
        ...
        awayTeamName: { name: 'Philadelphia 76ers', abr: 'PHI' },
        homeTeamName: { name: 'Golden State Warriors', abr: 'GSW' },
        awayActions: { 'Away One': [] },
        awayActionsAll: { 'Away One': [] },
        homeActions: { 'Home One': [] },
        homeActionsAll: { 'Home One': [] },
